...
extern list_node * emmited_quads_temp;
extern list_node * curr_emmited_quads_temp;
...
/* Performs the backpacthing */
void backpatch(list_node *,unsigned int);

/* Backpatches all the jumps in the given length */
